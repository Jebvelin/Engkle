...
DocumentReference? get currentUserReference =>
    loggedIn ? PropertiesRecord.collection.doc(currentUser!.uid) : null;

PropertiesRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : PropertiesRecord.getDocument(PropertiesRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
