...
import 'category3_model.dart';
export 'category3_model.dart';

class Category3Widget extends StatefulWidget {
  const Category3Widget({super.key});

  static String routeName = 'Category3';
  static String routePath = '/category3';
...
class _Category3WidgetState extends State<Category3Widget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Category3Model());
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context
                                          .pushNamed(Apple31Widget.routeName);
                                    },
                                    child: Container(
                                      width: MediaQuery.sizeOf(context).width *
                                          0.85,
