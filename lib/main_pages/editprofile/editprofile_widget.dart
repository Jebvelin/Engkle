...
class _EditprofileWidgetState extends State<EditprofileWidget>
  ...
  void initState() {
    ...
    _model.changeUsernameTextController ??= TextEditingController();
    _model.changeUsernameFocusNode ??= FocusNode();
                      ...
                      children: [
                        Expanded(
                          child: Container(
                            width: 200.0,
                            child: TextFormField(
                              controller: _model.changeUsernameTextController,
                              focusNode: _model.changeUsernameFocusNode,
                              autofocus: false,
                              obscureText: false,
                  ...
                  onPressed: () async {
                    await currentUserReference!
                      ...
                      userName: valueOrDefault<String>(
                        _model.changeUsernameTextController.text,
                        'ชื่อ  นามสกุล',
                      ),
                    ));
