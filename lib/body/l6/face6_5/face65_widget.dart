...
import 'face65_model.dart';
export 'face65_model.dart';

class Face65Widget extends StatefulWidget {
  const Face65Widget({super.key});

  static String routeName = 'Face6-5';
  static String routePath = '/face65';

  @override
  State<Face65Widget> createState() => _Face65WidgetState();
}

class _Face65WidgetState extends State<Face65Widget>
    with TickerProviderStateMixin {
  late Face65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Face65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1534528741775-53994a69daeb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxGYWNlfGVufDB8fHx8MTczNTE4NDE5NHww&ixlib=rb-4.0.3&q=80&w=1080',
