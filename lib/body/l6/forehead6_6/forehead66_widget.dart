...
import 'forehead66_model.dart';
export 'forehead66_model.dart';

class Forehead66Widget extends StatefulWidget {
  const Forehead66Widget({super.key});

  static String routeName = 'Forehead6-6';
  static String routePath = '/forehead66';

  @override
  State<Forehead66Widget> createState() => _Forehead66WidgetState();
}

class _Forehead66WidgetState extends State<Forehead66Widget>
    with TickerProviderStateMixin {
  late Forehead66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Forehead66Model());
                        ...
                        if (FFAppState().randomPage == 4) {
                          ...
                          if (FFAppState().randomPage == 5) {
                            ...
                            if (FFAppState().randomPage == 6) {
                              ...
                              context.pushNamed(Forehead66Widget.routeName);
                            } else {
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1589395937646-cc70671eca60?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxGb3JlaGVhZHxlbnwwfHx8fDE3MzUxODQyMTZ8MA&ixlib=rb-4.0.3&q=80&w=1080',
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (FFAppState().result == 'เยี่ยมมาก!') {
                              FFAppState().scoreBody =
                                  FFAppState().scoreBody + 1;
                              safeSetState(() {});

                              await currentUserReference!
                                  .update(createPropertiesRecordData(
                                scoreBody6: FFAppState().scoreBody,
                              ));
