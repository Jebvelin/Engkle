...
import 'hair67_model.dart';
export 'hair67_model.dart';

class Hair67Widget extends StatefulWidget {
  const Hair67Widget({super.key});

  static String routeName = 'Hair6-7';
  static String routePath = '/hair67';

  @override
  State<Hair67Widget> createState() => _Hair67WidgetState();
}

class _Hair67WidgetState extends State<Hair67Widget>
    with TickerProviderStateMixin {
  late Hair67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hair67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1472747624745-ce92d32d3c24?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxIYWlyfGVufDB8fHx8MTczNTE4NDIzM3ww&ixlib=rb-4.0.3&q=80&w=1080',
