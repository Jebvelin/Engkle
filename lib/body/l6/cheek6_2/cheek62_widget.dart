...
import 'cheek62_model.dart';
export 'cheek62_model.dart';

class Cheek62Widget extends StatefulWidget {
  const Cheek62Widget({super.key});

  static String routeName = 'Cheek6-2';
  static String routePath = '/cheek62';

  @override
  State<Cheek62Widget> createState() => _Cheek62WidgetState();
}

class _Cheek62WidgetState extends State<Cheek62Widget>
    with TickerProviderStateMixin {
  late Cheek62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cheek62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1541715301255-12a4839b424a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxDaGVla3xlbnwwfHx8fDE3MzUxODQxMjJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
