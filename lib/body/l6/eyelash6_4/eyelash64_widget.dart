...
import 'eyelash64_model.dart';
export 'eyelash64_model.dart';

class Eyelash64Widget extends StatefulWidget {
  const Eyelash64Widget({super.key});

  static String routeName = 'Eyelash6-4';
  static String routePath = '/eyelash64';

  @override
  State<Eyelash64Widget> createState() => _Eyelash64WidgetState();
}

class _Eyelash64WidgetState extends State<Eyelash64Widget>
    with TickerProviderStateMixin {
  late Eyelash64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eyelash64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1540544732960-63c240c37388?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxFeWVsYXNofGVufDB8fHx8MTczNTE4NDE4Nnww&ixlib=rb-4.0.3&q=80&w=1080',
