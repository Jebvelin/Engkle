...
import 'head68_model.dart';
export 'head68_model.dart';

class Head68Widget extends StatefulWidget {
  const Head68Widget({super.key});

  static String routeName = 'Head6-8';
  static String routePath = '/head68';

  @override
  State<Head68Widget> createState() => _Head68WidgetState();
}

class _Head68WidgetState extends State<Head68Widget>
    with TickerProviderStateMixin {
  late Head68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Head68Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1589837396034-518c01de601a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxIZWFkfGVufDB8fHx8MTczNTE4NDI0N3ww&ixlib=rb-4.0.3&q=80&w=1080',
