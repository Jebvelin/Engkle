...
import 'skull610_model.dart';
export 'skull610_model.dart';

class Skull610Widget extends StatefulWidget {
  const Skull610Widget({super.key});

  static String routeName = 'Skull6-10';
  static String routePath = '/skull610';

  @override
  State<Skull610Widget> createState() => _Skull610WidgetState();
}

class _Skull610WidgetState extends State<Skull610Widget>
    with TickerProviderStateMixin {
  late Skull610Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Skull610Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1582380595031-ef1b29d7fa05?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxTa3VsbHxlbnwwfHx8fDE3MzUxODQyNzR8MA&ixlib=rb-4.0.3&q=80&w=1080',
