...
import 'eyebrow63_model.dart';
export 'eyebrow63_model.dart';

class Eyebrow63Widget extends StatefulWidget {
  const Eyebrow63Widget({super.key});

  static String routeName = 'Eyebrow6-3';
  static String routePath = '/eyebrow63';

  @override
  State<Eyebrow63Widget> createState() => _Eyebrow63WidgetState();
}

class _Eyebrow63WidgetState extends State<Eyebrow63Widget>
    with TickerProviderStateMixin {
  late Eyebrow63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Eyebrow63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1494869042583-f6c911f04b4c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw4fHxFeWVicm93fGVufDB8fHx8MTczNTE4NDE2M3ww&ixlib=rb-4.0.3&q=80&w=1080',
