...
import 'pupil69_model.dart';
export 'pupil69_model.dart';

class Pupil69Widget extends StatefulWidget {
  const Pupil69Widget({super.key});

  static String routeName = 'Pupil6-9';
  static String routePath = '/pupil69';

  @override
  State<Pupil69Widget> createState() => _Pupil69WidgetState();
}

class _Pupil69WidgetState extends State<Pupil69Widget>
    with TickerProviderStateMixin {
  late Pupil69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pupil69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1483519173755-be893fab1f46?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw3fHxQdXBpbHxlbnwwfHx8fDE3MzUxODQyNjR8MA&ixlib=rb-4.0.3&q=80&w=1080',
