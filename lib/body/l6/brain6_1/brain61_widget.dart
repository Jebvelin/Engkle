...
import 'brain61_model.dart';
export 'brain61_model.dart';

class Brain61Widget extends StatefulWidget {
  const Brain61Widget({super.key});

  static String routeName = 'Brain6-1';
  static String routePath = '/brain61';

  @override
  State<Brain61Widget> createState() => _Brain61WidgetState();
}

class _Brain61WidgetState extends State<Brain61Widget>
    with TickerProviderStateMixin {
  late Brain61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Brain61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1617791160536-598cf32026fb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxCcmFpbnxlbnwwfHx8fDE3MzUxODQxMTF8MA&ixlib=rb-4.0.3&q=80&w=1080',
