...
import 'football64_model.dart';
export 'football64_model.dart';

class Football64Widget extends StatefulWidget {
  const Football64Widget({super.key});

  static String routeName = 'Football6-4';
  static String routePath = '/football64';

  @override
  State<Football64Widget> createState() => _Football64WidgetState();
}

class _Football64WidgetState extends State<Football64Widget>
    with TickerProviderStateMixin {
  late Football64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Football64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1624880357913-a8539238245b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxGb290YmFsbHxlbnwwfHx8fDE3MzUxODQ2MDV8MA&ixlib=rb-4.0.3&q=80&w=1080',
