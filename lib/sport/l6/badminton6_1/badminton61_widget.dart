...
import 'badminton61_model.dart';
export 'badminton61_model.dart';

class Badminton61Widget extends StatefulWidget {
  const Badminton61Widget({super.key});

  static String routeName = 'Badminton6-1';
  static String routePath = '/badminton61';

  @override
  State<Badminton61Widget> createState() => _Badminton61WidgetState();
}

class _Badminton61WidgetState extends State<Badminton61Widget>
    with TickerProviderStateMixin {
  late Badminton61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Badminton61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1599474924187-334a4ae5bd3c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxCYWRtaW50b258ZW58MHx8fHwxNzM1MTg0NTc1fDA&ixlib=rb-4.0.3&q=80&w=1080',
