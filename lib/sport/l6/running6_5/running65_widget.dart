...
import 'running65_model.dart';
export 'running65_model.dart';

class Running65Widget extends StatefulWidget {
  const Running65Widget({super.key});

  static String routeName = 'Running6-5';
  static String routePath = '/running65';

  @override
  State<Running65Widget> createState() => _Running65WidgetState();
}

class _Running65WidgetState extends State<Running65Widget>
    with TickerProviderStateMixin {
  late Running65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Running65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1489659831163-682b5af42225?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxSdW5uaW5nfGVufDB8fHx8MTczNTE4NDYxNnww&ixlib=rb-4.0.3&q=80&w=1080',
