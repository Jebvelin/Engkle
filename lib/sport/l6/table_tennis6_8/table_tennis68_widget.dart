...
import 'table_tennis68_model.dart';
export 'table_tennis68_model.dart';

class TableTennis68Widget extends StatefulWidget {
  const TableTennis68Widget({super.key});

  static String routeName = 'TableTennis6-8';
  static String routePath = '/tableTennis68';

  @override
  State<TableTennis68Widget> createState() => _TableTennis68WidgetState();
}

class _TableTennis68WidgetState extends State<TableTennis68Widget>
    with TickerProviderStateMixin {
  late TableTennis68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TableTennis68Model());
                        ...
                        if (FFAppState().randomPage == 4) {
                          ...
                          if (FFAppState().randomPage == 5) {
                            ...
                            if (FFAppState().randomPage == 6) {
                              ...
                              context.pushNamed(Skating66Widget.routeName);
                            } else {
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1711377448935-d271f954a050?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxUYWJsZVRlbm5pc3xlbnwwfHx8fDE3MzUxODQ2NDR8MA&ixlib=rb-4.0.3&q=80&w=1080',
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (FFAppState().result == 'เยี่ยมมาก!') {
                              FFAppState().scoreSports =
                                  FFAppState().scoreSports + 1;
                              safeSetState(() {});

                              await currentUserReference!
                                  .update(createPropertiesRecordData(
                                scoreSport6: FFAppState().scoreSports,
                              ));
