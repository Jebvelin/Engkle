...
import 'skating66_model.dart';
export 'skating66_model.dart';

class Skating66Widget extends StatefulWidget {
  const Skating66Widget({super.key});

  static String routeName = 'Skating6-6';
  static String routePath = '/skating66';

  @override
  State<Skating66Widget> createState() => _Skating66WidgetState();
}

class _Skating66WidgetState extends State<Skating66Widget>
    with TickerProviderStateMixin {
  late Skating66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Skating66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1547447546-526c3f7462aa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxTa2F0aW5nfGVufDB8fHx8MTczNTE4NDYyNHww&ixlib=rb-4.0.3&q=80&w=1080',
