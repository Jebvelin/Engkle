...
import 'swimming67_model.dart';
export 'swimming67_model.dart';

class Swimming67Widget extends StatefulWidget {
  const Swimming67Widget({super.key});

  static String routeName = 'Swimming6-7';
  static String routePath = '/swimming67';

  @override
  State<Swimming67Widget> createState() => _Swimming67WidgetState();
}

class _Swimming67WidgetState extends State<Swimming67Widget>
    with TickerProviderStateMixin {
  late Swimming67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Swimming67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1600965962361-9035dbfd1c50?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxTd2ltbWluZ3xlbnwwfHx8fDE3MzUxODQ2MzV8MA&ixlib=rb-4.0.3&q=80&w=1080',
