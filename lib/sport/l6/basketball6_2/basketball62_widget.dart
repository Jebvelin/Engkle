...
import 'basketball62_model.dart';
export 'basketball62_model.dart';

class Basketball62Widget extends StatefulWidget {
  const Basketball62Widget({super.key});

  static String routeName = 'Basketball6-2';
  static String routePath = '/basketball62';

  @override
  State<Basketball62Widget> createState() => _Basketball62WidgetState();
}

class _Basketball62WidgetState extends State<Basketball62Widget>
    with TickerProviderStateMixin {
  late Basketball62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Basketball62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1519861531473-9200262188bf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxCYXNrZXRiYWxsfGVufDB8fHx8MTczNTE4NDU4NHww&ixlib=rb-4.0.3&q=80&w=1080',
