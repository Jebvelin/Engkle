...
import 'volleyball610_model.dart';
export 'volleyball610_model.dart';

class Volleyball610Widget extends StatefulWidget {
  const Volleyball610Widget({super.key});

  static String routeName = 'Volleyball6-10';
  static String routePath = '/volleyball610';

  @override
  State<Volleyball610Widget> createState() => _Volleyball610WidgetState();
}

class _Volleyball610WidgetState extends State<Volleyball610Widget>
    with TickerProviderStateMixin {
  late Volleyball610Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Volleyball610Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxWb2xsZXliYWxsfGVufDB8fHx8MTczNTE4NDY2MXww&ixlib=rb-4.0.3&q=80&w=1080',
