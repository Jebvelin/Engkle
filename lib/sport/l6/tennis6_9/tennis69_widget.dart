...
import 'tennis69_model.dart';
export 'tennis69_model.dart';

class Tennis69Widget extends StatefulWidget {
  const Tennis69Widget({super.key});

  static String routeName = 'Tennis6-9';
  static String routePath = '/tennis69';

  @override
  State<Tennis69Widget> createState() => _Tennis69WidgetState();
}

class _Tennis69WidgetState extends State<Tennis69Widget>
    with TickerProviderStateMixin {
  late Tennis69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Tennis69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1526888935184-a82d2a4b7e67?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxUZW5uaXN8ZW58MHx8fHwxNzM1MTg0NjUyfDA&ixlib=rb-4.0.3&q=80&w=1080',
