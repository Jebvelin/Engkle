...
import 'cycling63_model.dart';
export 'cycling63_model.dart';

class Cycling63Widget extends StatefulWidget {
  const Cycling63Widget({super.key});

  static String routeName = 'Cycling6-3';
  static String routePath = '/cycling63';

  @override
  State<Cycling63Widget> createState() => _Cycling63WidgetState();
}

class _Cycling63WidgetState extends State<Cycling63Widget>
    with TickerProviderStateMixin {
  late Cycling63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cycling63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1534146789009-76ed5060ec70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxDeWNsaW5nfGVufDB8fHx8MTczNTE4NDU5N3ww&ixlib=rb-4.0.3&q=80&w=1080',
