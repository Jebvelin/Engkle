...
import 'art61_model.dart';
export 'art61_model.dart';

class Art61Widget extends StatefulWidget {
  const Art61Widget({super.key});

  static String routeName = 'Art6-1';
  static String routePath = '/art61';

  @override
  State<Art61Widget> createState() => _Art61WidgetState();
}

class _Art61WidgetState extends State<Art61Widget>
    with TickerProviderStateMixin {
  late Art61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Art61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1471666875520-c75081f42081?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw3fHxBcnR8ZW58MHx8fHwxNzM1MDQ3ODIxfDA&ixlib=rb-4.0.3&q=80&w=1080',
