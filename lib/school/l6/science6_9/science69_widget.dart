...
import 'science69_model.dart';
export 'science69_model.dart';

class Science69Widget extends StatefulWidget {
  const Science69Widget({super.key});

  static String routeName = 'Science6-9';
  static String routePath = '/science69';

  @override
  State<Science69Widget> createState() => _Science69WidgetState();
}

class _Science69WidgetState extends State<Science69Widget>
    with TickerProviderStateMixin {
  late Science69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Science69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1486825586573-7131f7991bdd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxTY2llbmNlfGVufDB8fHx8MTczNTExNjEyOXww&ixlib=rb-4.0.3&q=80&w=1080',
