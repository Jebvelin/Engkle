...
import 'highlighter66_model.dart';
export 'highlighter66_model.dart';

class Highlighter66Widget extends StatefulWidget {
  const Highlighter66Widget({super.key});

  static String routeName = 'Highlighter6-6';
  static String routePath = '/highlighter66';

  @override
  State<Highlighter66Widget> createState() => _Highlighter66WidgetState();
}

class _Highlighter66WidgetState extends State<Highlighter66Widget>
    with TickerProviderStateMixin {
  late Highlighter66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Highlighter66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1586764635350-4f88a6a30a52?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxIaWdobGlnaHRlcnxlbnwwfHx8fDE3MzUxMTYwNDh8MA&ixlib=rb-4.0.3&q=80&w=1080',
