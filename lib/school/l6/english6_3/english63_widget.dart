...
import 'english63_model.dart';
export 'english63_model.dart';

class English63Widget extends StatefulWidget {
  const English63Widget({super.key});

  static String routeName = 'English6-3';
  static String routePath = '/english63';

  @override
  State<English63Widget> createState() => _English63WidgetState();
}

class _English63WidgetState extends State<English63Widget>
    with TickerProviderStateMixin {
  late English63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => English63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1543109740-4bdb38fda756?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxFbmdsaXNofGVufDB8fHx8MTczNTExNTk2N3ww&ixlib=rb-4.0.3&q=80&w=1080',
