...
import 'geography65_model.dart';
export 'geography65_model.dart';

class Geography65Widget extends StatefulWidget {
  const Geography65Widget({super.key});

  static String routeName = 'Geography6-5';
  static String routePath = '/geography65';

  @override
  State<Geography65Widget> createState() => _Geography65WidgetState();
}

class _Geography65WidgetState extends State<Geography65Widget>
    with TickerProviderStateMixin {
  late Geography65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Geography65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1576767798470-53d52f75d921?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxHZW9ncmFwaHklMjB8ZW58MHx8fHwxNzM1MTE2MDI1fDA&ixlib=rb-4.0.3&q=80&w=1080',
