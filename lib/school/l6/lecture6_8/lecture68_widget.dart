...
import 'lecture68_model.dart';
export 'lecture68_model.dart';

class Lecture68Widget extends StatefulWidget {
  const Lecture68Widget({super.key});

  static String routeName = 'Lecture6-8';
  static String routePath = '/lecture68';

  @override
  State<Lecture68Widget> createState() => _Lecture68WidgetState();
}

class _Lecture68WidgetState extends State<Lecture68Widget>
    with TickerProviderStateMixin {
  late Lecture68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Lecture68Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1664382953518-4a664ab8a8c9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxMZWN0dXJlfGVufDB8fHx8MTczNTExNjEwNHww&ixlib=rb-4.0.3&q=80&w=1080',
