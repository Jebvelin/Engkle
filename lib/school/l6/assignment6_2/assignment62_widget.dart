...
import 'assignment62_model.dart';
export 'assignment62_model.dart';

class Assignment62Widget extends StatefulWidget {
  const Assignment62Widget({super.key});

  static String routeName = 'Assignment6-2';
  static String routePath = '/assignment62';

  @override
  State<Assignment62Widget> createState() => _Assignment62WidgetState();
}

class _Assignment62WidgetState extends State<Assignment62Widget>
    with TickerProviderStateMixin {
  late Assignment62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Assignment62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxBc3NpZ25tZW50fGVufDB8fHx8MTczNTExNTk0N3ww&ixlib=rb-4.0.3&q=80&w=1080',
