...
import 'exam64_model.dart';
export 'exam64_model.dart';

class Exam64Widget extends StatefulWidget {
  const Exam64Widget({super.key});

  static String routeName = 'Exam6-4';
  static String routePath = '/exam64';

  @override
  State<Exam64Widget> createState() => _Exam64WidgetState();
}

class _Exam64WidgetState extends State<Exam64Widget>
    with TickerProviderStateMixin {
  late Exam64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Exam64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxFeGFtfGVufDB8fHx8MTczNTExNjAwOXww&ixlib=rb-4.0.3&q=80&w=1080',
