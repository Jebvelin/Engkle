...
import 'history67_model.dart';
export 'history67_model.dart';

class History67Widget extends StatefulWidget {
  const History67Widget({super.key});

  static String routeName = 'History6-7';
  static String routePath = '/history67';

  @override
  State<History67Widget> createState() => _History67WidgetState();
}

class _History67WidgetState extends State<History67Widget>
    with TickerProviderStateMixin {
  late History67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => History67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1527922751658-fdc12370761e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyNHx8SGlzdG9yeXxlbnwwfHx8fDE3MzUxMTYwNjR8MA&ixlib=rb-4.0.3&q=80&w=1080',
