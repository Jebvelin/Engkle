...
import 'ruler310_model.dart';
export 'ruler310_model.dart';

class Ruler310Widget extends StatefulWidget {
  const Ruler310Widget({super.key});

  static String routeName = 'Ruler3-10';
  static String routePath = '/ruler310';

  @override
  State<Ruler310Widget> createState() => _Ruler310WidgetState();
}

class _Ruler310WidgetState extends State<Ruler310Widget>
    with TickerProviderStateMixin {
  late Ruler310Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Ruler310Model());
