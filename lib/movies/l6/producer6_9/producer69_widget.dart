...
import 'producer69_model.dart';
export 'producer69_model.dart';

class Producer69Widget extends StatefulWidget {
  const Producer69Widget({super.key});

  static String routeName = 'Producer6-9';
  static String routePath = '/producer69';

  @override
  State<Producer69Widget> createState() => _Producer69WidgetState();
}

class _Producer69WidgetState extends State<Producer69Widget>
    with TickerProviderStateMixin {
  late Producer69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Producer69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1486693128850-a77436e7ba3c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxQcm9kdWNlcnxlbnwwfHx8fDE3MzUxODQwNzF8MA&ixlib=rb-4.0.3&q=80&w=1080',
