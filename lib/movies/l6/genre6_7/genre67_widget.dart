...
import 'genre67_model.dart';
export 'genre67_model.dart';

class Genre67Widget extends StatefulWidget {
  const Genre67Widget({super.key});

  static String routeName = 'Genre6-7';
  static String routePath = '/genre67';

  @override
  State<Genre67Widget> createState() => _Genre67WidgetState();
}

class _Genre67WidgetState extends State<Genre67Widget>
    with TickerProviderStateMixin {
  late Genre67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Genre67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1623018035813-9cfb5b502e04?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw0fHxHZW5yZXxlbnwwfHx8fDE3MzUxODQwNDN8MA&ixlib=rb-4.0.3&q=80&w=1080',
