...
import 'documentary65_model.dart';
export 'documentary65_model.dart';

class Documentary65Widget extends StatefulWidget {
  const Documentary65Widget({super.key});

  static String routeName = 'Documentary6-5';
  static String routePath = '/documentary65';

  @override
  State<Documentary65Widget> createState() => _Documentary65WidgetState();
}

class _Documentary65WidgetState extends State<Documentary65Widget>
    with TickerProviderStateMixin {
  late Documentary65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Documentary65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1723833651274-cf1a94c398be?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMXx8RG9jdW1lbnRhcnl8ZW58MHx8fHwxNzM1MTg0MDA3fDA&ixlib=rb-4.0.3&q=80&w=1080',
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (FFAppState().result == 'เยี่ยมมาก!') {
                              FFAppState().scoreMovies =
                                  FFAppState().scoreMovies + 1;
                              safeSetState(() {});

                              await currentUserReference!
                                  .update(createPropertiesRecordData(
                                scoreMovies6: FFAppState().scoreMovies,
                              ));
