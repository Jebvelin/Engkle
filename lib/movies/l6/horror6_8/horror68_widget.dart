...
import 'horror68_model.dart';
export 'horror68_model.dart';

class Horror68Widget extends StatefulWidget {
  const Horror68Widget({super.key});

  static String routeName = 'Horror6-8';
  static String routePath = '/horror68';

  @override
  State<Horror68Widget> createState() => _Horror68WidgetState();
}

class _Horror68WidgetState extends State<Horror68Widget>
    with TickerProviderStateMixin {
  late Horror68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Horror68Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1494376877685-d3d2559d4f82?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxIb3Jyb3J8ZW58MHx8fHwxNzM1MTg0MDU3fDA&ixlib=rb-4.0.3&q=80&w=1080',
