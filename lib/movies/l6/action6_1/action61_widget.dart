...
import 'action61_model.dart';
export 'action61_model.dart';

class Action61Widget extends StatefulWidget {
  const Action61Widget({super.key});

  static String routeName = 'Action6-1';
  static String routePath = '/action61';

  @override
  State<Action61Widget> createState() => _Action61WidgetState();
}

class _Action61WidgetState extends State<Action61Widget>
    with TickerProviderStateMixin {
  late Action61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Action61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1490775696818-7832285c7240?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxBY3Rpb258ZW58MHx8fHwxNzM1MTE2Nzk0fDA&ixlib=rb-4.0.3&q=80&w=1080',
