...
import 'character63_model.dart';
export 'character63_model.dart';

class Character63Widget extends StatefulWidget {
  const Character63Widget({super.key});

  static String routeName = 'Character6-3';
  static String routePath = '/character63';

  @override
  State<Character63Widget> createState() => _Character63WidgetState();
}

class _Character63WidgetState extends State<Character63Widget>
    with TickerProviderStateMixin {
  late Character63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Character63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1617289755070-3590b660a06e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxDaGFyYWN0ZXJ8ZW58MHx8fHwxNzM1MTgzOTYwfDA&ixlib=rb-4.0.3&q=80&w=1080',
