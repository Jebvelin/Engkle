...
import 'romance610_model.dart';
export 'romance610_model.dart';

class Romance610Widget extends StatefulWidget {
  const Romance610Widget({super.key});

  static String routeName = 'Romance6-10';
  static String routePath = '/romance610';

  @override
  State<Romance610Widget> createState() => _Romance610WidgetState();
}

class _Romance610WidgetState extends State<Romance610Widget>
    with TickerProviderStateMixin {
  late Romance610Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Romance610Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1496080940026-ce069e2759f5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxSb21hbmNlfGVufDB8fHx8MTczNTE4NDA4OXww&ixlib=rb-4.0.3&q=80&w=1080',
