...
import 'drama66_model.dart';
export 'drama66_model.dart';

class Drama66Widget extends StatefulWidget {
  const Drama66Widget({super.key});

  static String routeName = 'Drama6-6';
  static String routePath = '/drama66';

  @override
  State<Drama66Widget> createState() => _Drama66WidgetState();
}

class _Drama66WidgetState extends State<Drama66Widget>
    with TickerProviderStateMixin {
  late Drama66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Drama66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1611673983948-18286e86703e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMnx8RHJhbWF8ZW58MHx8fHwxNzM1MTg0MDI3fDA&ixlib=rb-4.0.3&q=80&w=1080',
