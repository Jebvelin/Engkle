...
import 'animation62_model.dart';
export 'animation62_model.dart';

class Animation62Widget extends StatefulWidget {
  const Animation62Widget({super.key});

  static String routeName = 'Animation6-2';
  static String routePath = '/animation62';

  @override
  State<Animation62Widget> createState() => _Animation62WidgetState();
}

class _Animation62WidgetState extends State<Animation62Widget>
    with TickerProviderStateMixin {
  late Animation62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Animation62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1631582053308-40f482e7ace5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHxBbmltYXRpb258ZW58MHx8fHwxNzM1MTgzOTQ1fDA&ixlib=rb-4.0.3&q=80&w=1080',
