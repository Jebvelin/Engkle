...
import 'comedy64_model.dart';
export 'comedy64_model.dart';

class Comedy64Widget extends StatefulWidget {
  const Comedy64Widget({super.key});

  static String routeName = 'Comedy6-4';
  static String routePath = '/comedy64';

  @override
  State<Comedy64Widget> createState() => _Comedy64WidgetState();
}

class _Comedy64WidgetState extends State<Comedy64Widget>
    with TickerProviderStateMixin {
  late Comedy64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Comedy64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1681641095463-b4d3693a0ee3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw2fHxqb2tlfGVufDB8fHx8MTczNTE4Mzk5NHww&ixlib=rb-4.0.3&q=80&w=1080',
