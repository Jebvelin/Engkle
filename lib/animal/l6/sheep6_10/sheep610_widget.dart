...
import 'sheep610_model.dart';
export 'sheep610_model.dart';

class Sheep610Widget extends StatefulWidget {
  const Sheep610Widget({super.key});

  static String routeName = 'Sheep6-10';
  static String routePath = '/sheep610';

  @override
  State<Sheep610Widget> createState() => _Sheep610WidgetState();
}

class _Sheep610WidgetState extends State<Sheep610Widget>
    with TickerProviderStateMixin {
  late Sheep610Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Sheep610Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1533415648777-407b626eb0fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxMnx8U2hlZXB8ZW58MHx8fHwxNzM1MTE2NzUzfDA&ixlib=rb-4.0.3&q=80&w=1080',
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (FFAppState().result == 'เยี่ยมมาก!') {
                              FFAppState().scoreAnimal =
                                  FFAppState().scoreAnimal + 1;
                              safeSetState(() {});

                              await currentUserReference!
                                  .update(createPropertiesRecordData(
                                scoreAnimal6: FFAppState().scoreAnimal,
                              ));
