...
import 'cat62_model.dart';
export 'cat62_model.dart';

class Cat62Widget extends StatefulWidget {
  const Cat62Widget({super.key});

  static String routeName = 'Cat6-2';
  static String routePath = '/cat62';

  @override
  State<Cat62Widget> createState() => _Cat62WidgetState();
}

class _Cat62WidgetState extends State<Cat62Widget>
    with TickerProviderStateMixin {
  late Cat62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cat62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw3fHxDYXR8ZW58MHx8fHwxNzM1MTE2NTM4fDA&ixlib=rb-4.0.3&q=80&w=1080',
