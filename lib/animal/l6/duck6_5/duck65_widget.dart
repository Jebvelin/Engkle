...
import 'duck65_model.dart';
export 'duck65_model.dart';

class Duck65Widget extends StatefulWidget {
  const Duck65Widget({super.key});

  static String routeName = 'Duck6-5';
  static String routePath = '/duck65';

  @override
  State<Duck65Widget> createState() => _Duck65WidgetState();
}

class _Duck65WidgetState extends State<Duck65Widget>
    with TickerProviderStateMixin {
  late Duck65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Duck65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1484704407203-402da6f3879d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyM3x8RHVja3xlbnwwfHx8fDE3MzUxMTY2MDB8MA&ixlib=rb-4.0.3&q=80&w=1080',
