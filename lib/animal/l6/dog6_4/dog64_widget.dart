...
import 'dog64_model.dart';
export 'dog64_model.dart';

class Dog64Widget extends StatefulWidget {
  const Dog64Widget({super.key});

  static String routeName = 'Dog6-4';
  static String routePath = '/dog64';

  @override
  State<Dog64Widget> createState() => _Dog64WidgetState();
}

class _Dog64WidgetState extends State<Dog64Widget>
    with TickerProviderStateMixin {
  late Dog64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Dog64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1505628346881-b72b27e84530?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxM3x8RG9nfGVufDB8fHx8MTczNTExNjU2OXww&ixlib=rb-4.0.3&q=80&w=1080',
