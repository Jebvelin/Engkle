...
import 'fish66_model.dart';
export 'fish66_model.dart';

class Fish66Widget extends StatefulWidget {
  const Fish66Widget({super.key});

  static String routeName = 'Fish6-6';
  static String routePath = '/fish66';

  @override
  State<Fish66Widget> createState() => _Fish66WidgetState();
}

class _Fish66WidgetState extends State<Fish66Widget>
    with TickerProviderStateMixin {
  late Fish66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Fish66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1497671954146-59a89ff626ff?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw4fHxGaXNofGVufDB8fHx8MTczNTExNjY3Mnww&ixlib=rb-4.0.3&q=80&w=1080',
