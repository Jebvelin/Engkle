...
import 'pig69_model.dart';
export 'pig69_model.dart';

class Pig69Widget extends StatefulWidget {
  const Pig69Widget({super.key});

  static String routeName = 'Pig6-9';
  static String routePath = '/pig69';

  @override
  State<Pig69Widget> createState() => _Pig69WidgetState();
}

class _Pig69WidgetState extends State<Pig69Widget>
    with TickerProviderStateMixin {
  late Pig69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pig69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1587213128862-80345e23a71a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw0fHxQaWd8ZW58MHx8fHwxNzM1MTE2NzMyfDA&ixlib=rb-4.0.3&q=80&w=1080',
