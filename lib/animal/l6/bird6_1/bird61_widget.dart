...
import 'bird61_model.dart';
export 'bird61_model.dart';

class Bird61Widget extends StatefulWidget {
  const Bird61Widget({super.key});

  static String routeName = 'Bird6-1';
  static String routePath = '/bird61';

  @override
  State<Bird61Widget> createState() => _Bird61WidgetState();
}

class _Bird61WidgetState extends State<Bird61Widget>
    with TickerProviderStateMixin {
  late Bird61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Bird61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1486365227551-f3f90034a57c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxCaXJkfGVufDB8fHx8MTczNTExNjUyN3ww&ixlib=rb-4.0.3&q=80&w=1080',
