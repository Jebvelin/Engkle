...
import 'frog67_model.dart';
export 'frog67_model.dart';

class Frog67Widget extends StatefulWidget {
  const Frog67Widget({super.key});

  static String routeName = 'Frog6-7';
  static String routePath = '/frog67';

  @override
  State<Frog67Widget> createState() => _Frog67WidgetState();
}

class _Frog67WidgetState extends State<Frog67Widget>
    with TickerProviderStateMixin {
  late Frog67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Frog67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1502780402662-acc01c084a25?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyMHx8RnJvZ3xlbnwwfHx8fDE3MzUxMTY2OTJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
