...
import 'horse68_model.dart';
export 'horse68_model.dart';

class Horse68Widget extends StatefulWidget {
  const Horse68Widget({super.key});

  static String routeName = 'Horse6-8';
  static String routePath = '/horse68';

  @override
  State<Horse68Widget> createState() => _Horse68WidgetState();
}

class _Horse68WidgetState extends State<Horse68Widget>
    with TickerProviderStateMixin {
  late Horse68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Horse68Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/uploads/14136148007774dc82563/ce92d553?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxIb3JzZXxlbnwwfHx8fDE3MzUxMTY3MTd8MA&ixlib=rb-4.0.3&q=80&w=1080',
