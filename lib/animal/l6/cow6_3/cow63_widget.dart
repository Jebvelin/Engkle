...
import 'cow63_model.dart';
export 'cow63_model.dart';

class Cow63Widget extends StatefulWidget {
  const Cow63Widget({super.key});

  static String routeName = 'Cow6-3';
  static String routePath = '/cow63';

  @override
  State<Cow63Widget> createState() => _Cow63WidgetState();
}

class _Cow63WidgetState extends State<Cow63Widget>
    with TickerProviderStateMixin {
  late Cow63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cow63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1530268782463-418534b0affa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxDb3d8ZW58MHx8fHwxNzM1MTE2NTU0fDA&ixlib=rb-4.0.3&q=80&w=1080',
