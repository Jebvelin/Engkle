...
import 'cousin63_model.dart';
export 'cousin63_model.dart';

class Cousin63Widget extends StatefulWidget {
  const Cousin63Widget({super.key});

  static String routeName = 'Cousin6-3';
  static String routePath = '/cousin63';

  @override
  State<Cousin63Widget> createState() => _Cousin63WidgetState();
}

class _Cousin63WidgetState extends State<Cousin63Widget>
    with TickerProviderStateMixin {
  late Cousin63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cousin63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1692909998881-929b198205f9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxDb3VzaW58ZW58MHx8fHwxNzM1MTg0MzI0fDA&ixlib=rb-4.0.3&q=80&w=1080',
