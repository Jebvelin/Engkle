...
import 'father65_model.dart';
export 'father65_model.dart';

class Father65Widget extends StatefulWidget {
  const Father65Widget({super.key});

  static String routeName = 'Father6-5';
  static String routePath = '/father65';

  @override
  State<Father65Widget> createState() => _Father65WidgetState();
}

class _Father65WidgetState extends State<Father65Widget>
    with TickerProviderStateMixin {
  late Father65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Father65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1657664058220-a1bfc04e2e14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxGYXRoZXJ8ZW58MHx8fHwxNzM1MTg0MzQ1fDA&ixlib=rb-4.0.3&q=80&w=1080',
