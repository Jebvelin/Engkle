...
import 'grandfather66_model.dart';
export 'grandfather66_model.dart';

class Grandfather66Widget extends StatefulWidget {
  const Grandfather66Widget({super.key});

  static String routeName = 'Grandfather6-6';
  static String routePath = '/grandfather66';

  @override
  State<Grandfather66Widget> createState() => _Grandfather66WidgetState();
}

class _Grandfather66WidgetState extends State<Grandfather66Widget>
    with TickerProviderStateMixin {
  late Grandfather66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Grandfather66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1542105907-bbbb542a5f79?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxHcmFuZGZhdGhlcnxlbnwwfHx8fDE3MzUxODQzNTV8MA&ixlib=rb-4.0.3&q=80&w=1080',
