...
import 'sister69_model.dart';
export 'sister69_model.dart';

class Sister69Widget extends StatefulWidget {
  const Sister69Widget({super.key});

  static String routeName = 'Sister6-9';
  static String routePath = '/sister69';

  @override
  State<Sister69Widget> createState() => _Sister69WidgetState();
}

class _Sister69WidgetState extends State<Sister69Widget>
    with TickerProviderStateMixin {
  late Sister69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Sister69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1476234251651-f353703a034d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxTaXN0ZXJ8ZW58MHx8fHwxNzM1MTg0NDAzfDA&ixlib=rb-4.0.3&q=80&w=1080',
