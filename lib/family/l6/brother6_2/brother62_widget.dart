...
import 'brother62_model.dart';
export 'brother62_model.dart';

class Brother62Widget extends StatefulWidget {
  const Brother62Widget({super.key});

  static String routeName = 'Brother6-2';
  static String routePath = '/brother62';

  @override
  State<Brother62Widget> createState() => _Brother62WidgetState();
}

class _Brother62WidgetState extends State<Brother62Widget>
    with TickerProviderStateMixin {
  late Brother62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Brother62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1541020064206-98c1d21cbc5f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw4fHxCcm90aGVyfGVufDB8fHx8MTczNTE4NDMwN3ww&ixlib=rb-4.0.3&q=80&w=1080',
