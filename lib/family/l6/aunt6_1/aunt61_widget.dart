...
import 'aunt61_model.dart';
export 'aunt61_model.dart';

class Aunt61Widget extends StatefulWidget {
  const Aunt61Widget({super.key});

  static String routeName = 'Aunt6-1';
  static String routePath = '/aunt61';

  @override
  State<Aunt61Widget> createState() => _Aunt61WidgetState();
}

class _Aunt61WidgetState extends State<Aunt61Widget>
    with TickerProviderStateMixin {
  late Aunt61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Aunt61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1530047625168-4b29bfbbe1fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxBdW50fGVufDB8fHx8MTczNTE4NDI5Nnww&ixlib=rb-4.0.3&q=80&w=1080',
