...
import 'family64_model.dart';
export 'family64_model.dart';

class Family64Widget extends StatefulWidget {
  const Family64Widget({super.key});

  static String routeName = 'Family6-4';
  static String routePath = '/family64';

  @override
  State<Family64Widget> createState() => _Family64WidgetState();
}

class _Family64WidgetState extends State<Family64Widget>
    with TickerProviderStateMixin {
  late Family64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Family64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1643868420405-48e32c6f4620?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxGYW1pbHl8ZW58MHx8fHwxNzM1MTg0MzM1fDA&ixlib=rb-4.0.3&q=80&w=1080',
