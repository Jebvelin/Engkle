...
import 'mother68_model.dart';
export 'mother68_model.dart';

class Mother68Widget extends StatefulWidget {
  const Mother68Widget({super.key});

  static String routeName = 'Mother6-8';
  static String routePath = '/mother68';

  @override
  State<Mother68Widget> createState() => _Mother68WidgetState();
}

class _Mother68WidgetState extends State<Mother68Widget>
    with TickerProviderStateMixin {
  late Mother68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Mother68Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1542385151-efd9000785a0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw0fHxNb3RoZXJ8ZW58MHx8fHwxNzM1MTg0MzgzfDA&ixlib=rb-4.0.3&q=80&w=1080',
