...
import 'grandmother67_model.dart';
export 'grandmother67_model.dart';

class Grandmother67Widget extends StatefulWidget {
  const Grandmother67Widget({super.key});

  static String routeName = 'Grandmother6-7';
  static String routePath = '/grandmother67';

  @override
  State<Grandmother67Widget> createState() => _Grandmother67WidgetState();
}

class _Grandmother67WidgetState extends State<Grandmother67Widget>
    with TickerProviderStateMixin {
  late Grandmother67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Grandmother67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1526860918836-81de4cae5681?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHxHcmFuZG1vdGhlcnxlbnwwfHx8fDE3MzUxODQzNjR8MA&ixlib=rb-4.0.3&q=80&w=1080',
