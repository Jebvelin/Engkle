...
import 'pasta65_model.dart';
export 'pasta65_model.dart';

class Pasta65Widget extends StatefulWidget {
  const Pasta65Widget({super.key});

  static String routeName = 'Pasta6-5';
  static String routePath = '/pasta65';

  @override
  State<Pasta65Widget> createState() => _Pasta65WidgetState();
}

class _Pasta65WidgetState extends State<Pasta65Widget>
    with TickerProviderStateMixin {
  late Pasta65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pasta65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1556761223-4c4282c73f77?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxQYXN0YXxlbnwwfHx8fDE3MzUxMTY0MTJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
