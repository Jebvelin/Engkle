...
import 'sandwich68_model.dart';
export 'sandwich68_model.dart';

class Sandwich68Widget extends StatefulWidget {
  const Sandwich68Widget({super.key});

  static String routeName = 'Sandwich6-8';
  static String routePath = '/sandwich68';

  @override
  State<Sandwich68Widget> createState() => _Sandwich68WidgetState();
}

class _Sandwich68WidgetState extends State<Sandwich68Widget>
    with TickerProviderStateMixin {
  late Sandwich68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Sandwich68Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1481070414801-51fd732d7184?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxTYW5kd2ljaHxlbnwwfHx8fDE3MzUxMTY0NTJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
