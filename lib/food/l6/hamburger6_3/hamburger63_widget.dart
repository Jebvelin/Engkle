...
import 'hamburger63_model.dart';
export 'hamburger63_model.dart';

class Hamburger63Widget extends StatefulWidget {
  const Hamburger63Widget({super.key});

  static String routeName = 'Hamburger6-3';
  static String routePath = '/hamburger63';

  @override
  State<Hamburger63Widget> createState() => _Hamburger63WidgetState();
}

class _Hamburger63WidgetState extends State<Hamburger63Widget>
    with TickerProviderStateMixin {
  late Hamburger63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hamburger63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1529564879024-c54e7c2dd0e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHxIYW1idXJnZXJ8ZW58MHx8fHwxNzM1MTE2MzgwfDA&ixlib=rb-4.0.3&q=80&w=1080',
