...
import 'steak610_model.dart';
export 'steak610_model.dart';

class Steak610Widget extends StatefulWidget {
  const Steak610Widget({super.key});

  static String routeName = 'Steak6-10';
  static String routePath = '/steak610';

  @override
  State<Steak610Widget> createState() => _Steak610WidgetState();
}

class _Steak610WidgetState extends State<Steak610Widget>
    with TickerProviderStateMixin {
  late Steak610Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Steak610Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1504973960431-1c467e159aa4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxTdGVha3xlbnwwfHx8fDE3MzUxMTY0ODN8MA&ixlib=rb-4.0.3&q=80&w=1080',
