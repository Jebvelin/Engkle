...
import 'fried_rice62_model.dart';
export 'fried_rice62_model.dart';

class FriedRice62Widget extends StatefulWidget {
  const FriedRice62Widget({super.key});

  static String routeName = 'FriedRice6-2';
  static String routePath = '/friedRice62';

  @override
  State<FriedRice62Widget> createState() => _FriedRice62WidgetState();
}

class _FriedRice62WidgetState extends State<FriedRice62Widget>
    with TickerProviderStateMixin {
  late FriedRice62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FriedRice62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1709786204911-03e5857ffd9a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxGcmllZFJpY2V8ZW58MHx8fHwxNzM1MTE2MzY5fDA&ixlib=rb-4.0.3&q=80&w=1080',
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (FFAppState().result == 'เยี่ยมมาก!') {
                              FFAppState().scoreFood =
                                  FFAppState().scoreFood + 1;
                              safeSetState(() {});

                              await currentUserReference!
                                  .update(createPropertiesRecordData(
                                scoreFood6: FFAppState().scoreFood,
                              ));
