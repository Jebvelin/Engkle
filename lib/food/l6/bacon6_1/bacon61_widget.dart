...
import 'bacon61_model.dart';
export 'bacon61_model.dart';

class Bacon61Widget extends StatefulWidget {
  const Bacon61Widget({super.key});

  static String routeName = 'Bacon6-1';
  static String routePath = '/bacon61';

  @override
  State<Bacon61Widget> createState() => _Bacon61WidgetState();
}

class _Bacon61WidgetState extends State<Bacon61Widget>
    with TickerProviderStateMixin {
  late Bacon61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Bacon61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1694983361629-0363ab0d1b49?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHxiYWNvbnxlbnwwfHx8fDE3MzQ5MzE3ODl8MA&ixlib=rb-4.0.3&q=80&w=1080',
