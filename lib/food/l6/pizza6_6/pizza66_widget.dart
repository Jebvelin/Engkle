...
import 'pizza66_model.dart';
export 'pizza66_model.dart';

class Pizza66Widget extends StatefulWidget {
  const Pizza66Widget({super.key});

  static String routeName = 'Pizza6-6';
  static String routePath = '/pizza66';

  @override
  State<Pizza66Widget> createState() => _Pizza66WidgetState();
}

class _Pizza66WidgetState extends State<Pizza66Widget>
    with TickerProviderStateMixin {
  late Pizza66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pizza66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1513104890138-7c749659a591?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxQaXp6YXxlbnwwfHx8fDE3MzUxMTY0MjZ8MA&ixlib=rb-4.0.3&q=80&w=1080',
