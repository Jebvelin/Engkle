...
import 'salad67_model.dart';
export 'salad67_model.dart';

class Salad67Widget extends StatefulWidget {
  const Salad67Widget({super.key});

  static String routeName = 'Salad6-7';
  static String routePath = '/salad67';

  @override
  State<Salad67Widget> createState() => _Salad67WidgetState();
}

class _Salad67WidgetState extends State<Salad67Widget>
    with TickerProviderStateMixin {
  late Salad67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Salad67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1505253716362-afaea1d3d1af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxTYWxhZHxlbnwwfHx8fDE3MzUxMTY0NDJ8MA&ixlib=rb-4.0.3&q=80&w=1080',
