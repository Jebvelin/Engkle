...
import 'sausage69_model.dart';
export 'sausage69_model.dart';

class Sausage69Widget extends StatefulWidget {
  const Sausage69Widget({super.key});

  static String routeName = 'Sausage6-9';
  static String routePath = '/sausage69';

  @override
  State<Sausage69Widget> createState() => _Sausage69WidgetState();
}

class _Sausage69WidgetState extends State<Sausage69Widget>
    with TickerProviderStateMixin {
  late Sausage69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Sausage69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1624772398061-bbfa87ec6b5a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyNHx8U2F1c2FnZXxlbnwwfHx8fDE3MzUxMTY0NjZ8MA&ixlib=rb-4.0.3&q=80&w=1080',
