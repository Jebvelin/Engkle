...
import 'ice_cream64_model.dart';
export 'ice_cream64_model.dart';

class IceCream64Widget extends StatefulWidget {
  const IceCream64Widget({super.key});

  static String routeName = 'IceCream6-4';
  static String routePath = '/iceCream64';

  @override
  State<IceCream64Widget> createState() => _IceCream64WidgetState();
}

class _IceCream64WidgetState extends State<IceCream64Widget>
    with TickerProviderStateMixin {
  late IceCream64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IceCream64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1505075232616-5aea40f97c63?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxJY2VDcmVhbXxlbnwwfHx8fDE3MzUxMTYzOTN8MA&ixlib=rb-4.0.3&q=80&w=1080',
