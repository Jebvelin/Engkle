...
import 'firefighter65_model.dart';
export 'firefighter65_model.dart';

class Firefighter65Widget extends StatefulWidget {
  const Firefighter65Widget({super.key});

  static String routeName = 'Firefighter6-5';
  static String routePath = '/firefighter65';

  @override
  State<Firefighter65Widget> createState() => _Firefighter65WidgetState();
}

class _Firefighter65WidgetState extends State<Firefighter65Widget>
    with TickerProviderStateMixin {
  late Firefighter65Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Firefighter65Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1575867094974-9e16b6f55360?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxGaXJlZmlnaHRlcnxlbnwwfHx8fDE3MzUxODQ0OTV8MA&ixlib=rb-4.0.3&q=80&w=1080',
