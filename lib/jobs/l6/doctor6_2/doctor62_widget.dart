...
import 'doctor62_model.dart';
export 'doctor62_model.dart';

class Doctor62Widget extends StatefulWidget {
  const Doctor62Widget({super.key});

  static String routeName = 'Doctor6-2';
  static String routePath = '/doctor62';

  @override
  State<Doctor62Widget> createState() => _Doctor62WidgetState();
}

class _Doctor62WidgetState extends State<Doctor62Widget>
    with TickerProviderStateMixin {
  late Doctor62Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Doctor62Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1582750433449-648ed127bb54?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw5fHxEb2N0b3J8ZW58MHx8fHwxNzM1MDg4MjEzfDA&ixlib=rb-4.0.3&q=80&w=1080',
