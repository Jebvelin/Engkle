...
import 'nurse67_model.dart';
export 'nurse67_model.dart';

class Nurse67Widget extends StatefulWidget {
  const Nurse67Widget({super.key});

  static String routeName = 'Nurse6-7';
  static String routePath = '/nurse67';

  @override
  State<Nurse67Widget> createState() => _Nurse67WidgetState();
}

class _Nurse67WidgetState extends State<Nurse67Widget>
    with TickerProviderStateMixin {
  late Nurse67Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Nurse67Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1527613426441-4da17471b66d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxOdXJzZXxlbnwwfHx8fDE3MzUxODQ1MTV8MA&ixlib=rb-4.0.3&q=80&w=1080',
