...
import 'farmer64_model.dart';
export 'farmer64_model.dart';

class Farmer64Widget extends StatefulWidget {
  const Farmer64Widget({super.key});

  static String routeName = 'Farmer6-4';
  static String routePath = '/farmer64';

  @override
  State<Farmer64Widget> createState() => _Farmer64WidgetState();
}

class _Farmer64WidgetState extends State<Farmer64Widget>
    with TickerProviderStateMixin {
  late Farmer64Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Farmer64Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1527847263472-aa5338d178b8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxGYXJtZXJ8ZW58MHx8fHwxNzM1MTg0NDgyfDA&ixlib=rb-4.0.3&q=80&w=1080',
