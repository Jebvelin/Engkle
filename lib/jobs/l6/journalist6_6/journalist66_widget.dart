...
import 'journalist66_model.dart';
export 'journalist66_model.dart';

class Journalist66Widget extends StatefulWidget {
  const Journalist66Widget({super.key});

  static String routeName = 'Journalist6-6';
  static String routePath = '/journalist66';

  @override
  State<Journalist66Widget> createState() => _Journalist66WidgetState();
}

class _Journalist66WidgetState extends State<Journalist66Widget>
    with TickerProviderStateMixin {
  late Journalist66Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Journalist66Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1559523161-0fc0d8b38a7a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxKb3VybmFsaXN0fGVufDB8fHx8MTczNTE4NDUwNXww&ixlib=rb-4.0.3&q=80&w=1080',
