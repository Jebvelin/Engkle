...
import 'architect61_model.dart';
export 'architect61_model.dart';

class Architect61Widget extends StatefulWidget {
  const Architect61Widget({super.key});

  static String routeName = 'Architect6-1';
  static String routePath = '/architect61';

  @override
  State<Architect61Widget> createState() => _Architect61WidgetState();
}

class _Architect61WidgetState extends State<Architect61Widget>
    with TickerProviderStateMixin {
  late Architect61Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Architect61Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1598368195835-91e67f80c9d7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxBcmNoaXRlY3R8ZW58MHx8fHwxNzM1MTg0NDM0fDA&ixlib=rb-4.0.3&q=80&w=1080',
