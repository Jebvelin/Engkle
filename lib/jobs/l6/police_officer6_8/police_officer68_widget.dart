...
import 'police_officer68_model.dart';
export 'police_officer68_model.dart';

class PoliceOfficer68Widget extends StatefulWidget {
  const PoliceOfficer68Widget({super.key});

  static String routeName = 'PoliceOfficer6-8';
  static String routePath = '/policeOfficer68';

  @override
  State<PoliceOfficer68Widget> createState() => _PoliceOfficer68WidgetState();
}

class _PoliceOfficer68WidgetState extends State<PoliceOfficer68Widget>
    with TickerProviderStateMixin {
  late PoliceOfficer68Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PoliceOfficer68Model());
                        ...
                        if (FFAppState().randomPage == 4) {
                          ...
                          if (FFAppState().randomPage == 5) {
                            ...
                            if (FFAppState().randomPage == 6) {
                              ...
                              context.pushNamed(Journalist66Widget.routeName);
                            } else {
                              if (FFAppState().randomPage == 7) {
                                ...
                                if (FFAppState().randomPage == 8) {
                                  ...
                                  context.pushNamed(
                                    PoliceOfficer68Widget.routeName,
                                    extra: <String, dynamic>{
                                      kTransitionInfoKey: TransitionInfo(
                                        hasTransition: true,
                                        transitionType:
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1526659541029-256e1bf106e5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwyfHxQb2xpY2V8ZW58MHx8fHwxNzM1MTg0NTMxfDA&ixlib=rb-4.0.3&q=80&w=1080',
                          ...
                          onPressed: () async {
                            ...
                            if (FFAppState().result == 'เยี่ยมมาก!') {
                              ...
                              await currentUserReference!
                                ...
                                scoreJobs6: FFAppState().scoreJobs,
                              ));
