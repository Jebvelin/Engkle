...
import 'engineer63_model.dart';
export 'engineer63_model.dart';

class Engineer63Widget extends StatefulWidget {
  const Engineer63Widget({super.key});

  static String routeName = 'Engineer6-3';
  static String routePath = '/engineer63';

  @override
  State<Engineer63Widget> createState() => _Engineer63WidgetState();
}

class _Engineer63WidgetState extends State<Engineer63Widget>
    with TickerProviderStateMixin {
  late Engineer63Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Engineer63Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1581094481644-f2ab64522498?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw3fHxFbmdpbmVlcnxlbnwwfHx8fDE3MzUxODQ0NzB8MA&ixlib=rb-4.0.3&q=80&w=1080',
