...
import 'scientist69_model.dart';
export 'scientist69_model.dart';

class Scientist69Widget extends StatefulWidget {
  const Scientist69Widget({super.key});

  static String routeName = 'Scientist6-9';
  static String routePath = '/scientist69';

  @override
  State<Scientist69Widget> createState() => _Scientist69WidgetState();
}

class _Scientist69WidgetState extends State<Scientist69Widget>
    with TickerProviderStateMixin {
  late Scientist69Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Scientist69Model());
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl:
                                    'https://images.unsplash.com/photo-1578496481449-cf2e845cc00c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHw1fHxTY2llbnRpc3R8ZW58MHx8fHwxNzM1MTg0NTQ2fDA&ixlib=rb-4.0.3&q=80&w=1080',
